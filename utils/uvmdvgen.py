...
The generated objects extend inlined dv_base_* templates (no external dv_lib/cip_lib).
"""
import argparse
...
def main():
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="""Create interrupts interface in tb.""")
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="""Create alerts interface in tb.""")
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="""Create edn pull interface in tb.""")
    ...
    if args.gen_env:
        if not args.env_agents:
            args.env_agents = []
        gen_env.gen_env(args.name, args.has_ral,
